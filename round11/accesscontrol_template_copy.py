...
# Phan Viet Anh
# 256296
# Note: Everything work correctly
    ...
    def add_access(self, new_access_code):
        ...
        if new_access_code in DOORCODES.keys():
            ...
            if new_access_code in self.get_access():
                ...
                #
                # for code in self.get_access():
                #     if code not in area_list(DOORCODES):
                #
                ...
                #             break
                #
                #     elif new_access_code != code:
                #         added = True
                #
                # if added and new_access_code not in self.get_access():
                #     self.__access.append(new_access_code)
...
def list_data_info(data):
    ...
    # data_list = []
    # for card in data:
    #     access_info = card.get_id() + ', ' + card.get_name() + ', ' + 'access: ' \
    #                   + ', '.join(code for code in card.get_access())
    #     data_list.append(access_info)
    #
    # for card_holder in sorted(data_list):
    #     print(card_holder)
